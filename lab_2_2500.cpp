// lab_2_2500.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void find_random() {
    ...
    do {
        cin >> right;
        if (right < left) cout << "Правая границу должна быть больше левой" << endl;
    } while (right < left);
